...
# screen.geometry('365x470')
screen.iconbitmap('Apps.ico')

screen.maxsize(width=450, height=490)
screen.minsize(width=450, height=490)
...
entry1 = Entry(screen, bg='powder blue', font=('arial', 20, 'italic bold'), bd='20', justify='right', textvariable=tex)
...
btnsub = Button(screen, text='-', font=('arial', 20, 'italic bold'), bd=8, padx=20, pady=16, command=lambda: click('-'),
                activebackground='green', activeforeground='white', bg='powder blue')
...
btndiv = Button(screen, text='/', font=('arial', 20, 'italic bold'), bd=8, padx=20, pady=16, command=lambda: click('/'),
                activebackground='green', activeforeground='white', bg='powder blue')
btndiv.grid(row=4, column=3)

################## Advance

btnsin = Button(screen, text='sin', font=('arial', 20, 'italic bold'), bd=8, padx=20, pady=16, command=cmsin,
                activebackground='green', activeforeground='white', bg='powder blue')
btnsin.grid(row=0, column=5)

btncos = Button(screen, text='cos', font=('arial', 20, 'italic bold'), bd=8, padx=14, pady=16, command=cmcos,
                activebackground='green', activeforeground='white', bg='powder blue')
btncos.grid(row=1, column=5)

btntan = Button(screen, text='tan', font=('arial', 20, 'italic bold'), bd=8, padx=16, pady=16, command=cmtan,
                activebackground='green', activeforeground='white', bg='powder blue')
btntan.grid(row=2, column=5)

btnlog = Button(screen, text='log', font=('arial', 20, 'italic bold'), bd=8, padx=16, pady=16, command=cmlog,
                activebackground='green', activeforeground='white', bg='powder blue')
btnlog.grid(row=3, column=5)

btnsqrt = Button(screen, text='sqrt', font=('arial', 20, 'italic bold'), bd=8, padx=11, pady=16, command=cmsqrt,
                 activebackground='green', activeforeground='white', bg='powder blue')
